"""
SQLite 存储层，实现 quanttide_connect.repository.Repository Protocol。
"""
...
class Storage:
    ...
    def update_message(self, message_id: str, new_content: str) -> Message | None:
        ...
        self._db.commit()
        return self.get_message(message_id) if cur.rowcount > 0 else None
    ...
    def update_consensus_status(
        ...
        self._db.commit()
        return self.get_consensus(consensus_id) if cur.rowcount > 0 else None
